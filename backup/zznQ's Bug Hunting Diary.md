...
进一步分析发现，问题的根因是在多线程并发情况下使用 curl_cffi 的 [streaming](https://curl-cffi.readthedocs.io/en/latest/quick_start.html#streaming-response) 对资源操作的地方(perform,clean_after_perform)，存在条件竞争，导致内存错误。
