...
我并不是一名专业的漏洞挖研究员，只是会对生活和工作接触到或感兴趣的软件进行简单研究。
...
在试用 [grok2api_python](https://github.com/xLmiler/grok2api_python) 时会多次出现这个错误：![alt text](image-2.png)
...
- 完整报告：https://github.com/gopxl/beep/issues/209
- PR(解决方案)：https://github.com/gopxl/beep/pull/212
